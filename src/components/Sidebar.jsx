...
import { contextMenuItems, links, Links } from '../data/dummy'
...
const Sidebar = () => {
  ...
  const activeLink = 'flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-white text-md m-2 bg-sky-500/50';
